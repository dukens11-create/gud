    ...
    if (result == true && mounted) {
      try {
        ...
        if (truck == null) {
          ...
          if (mounted) {
            NavigationService.showSnackBar('Truck added successfully', isError: false);
          }
        } else {
          // Update existing truck
          await _truckService.updateTruck(truck.id, newTruck);
          if (mounted) {
            NavigationService.showSnackBar('Truck updated successfully', isError: false);
          }
        }
      } catch (e) {
        if (mounted) {
          NavigationService.showSnackBar('Error: $e', isError: true);
        }
      }
    }
  ...
  Future<void> _confirmDeleteTruck(Truck truck) async {
    ...
    if (confirmed == true && mounted) {
      try {
        ...
        if (mounted) {
          NavigationService.showSnackBar('Error deleting truck: $e', isError: true);
        }
      }
    }
  }
